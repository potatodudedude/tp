...
public class LogicManagerTest {
    ...
    private void assertCommandFailureForExceptionFromStorage(IOException e, String expectedMessage) {
        ...
        String addCommand = AddCommand.COMMAND_WORD + NAME_DESC_AMY + TELE_DESC_AMY
                + EMAIL_DESC_AMY + MODTUT_DESC_AMY;
        Person expectedPerson = new PersonBuilder(AMY).withModTuts(VALID_MODTUT_AMY).build();
